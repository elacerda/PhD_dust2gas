...
from PhD_dust2gas.tables_description import zone
from PhD_dust2gas.tables_description import galaxy
...
if __name__ == '__main__':
    ...
    for iGal, gal in enumerate(gals[0:max_gals]):
        ...
        row_zone['Mcor'] = K.integrated_Mcor
        row_zone['tau_V'] = K.integrated_keywords['A_V']*AVtoTauV
        row_zone['at_flux'] = at_flux_GAL
        row_zone['v_0'] = K.integrated_keywords['V_0']
        row_zone['v_d'] = K.integrated_keywords['V_0']
